...
--local overlay2 = sol.surface.create("hud/cutscene_bars.png") --
...
function map:on_started(destination)
  map:set_overlay()
sol.audio.play_music("/exteriors/castle_exterior_daytime")
end

function map:on_draw(destination_surface)
overlay2:draw(destination_surface)
