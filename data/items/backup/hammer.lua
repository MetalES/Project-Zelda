...
function item:on_using()
  ...
  -- Handle stakes.
   sol.audio.play_sound("/characters/link/voice/spin0")
   sol.timer.start(175, function() sol.audio.play_sound("/items/hammer/swing") ;end)
 
  item:set_pushed_stake(false)
  sol.timer.start(item, 450, function()
