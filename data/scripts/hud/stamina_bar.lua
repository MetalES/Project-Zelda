...
function stamina_bar:rebuild_surface()
  ...
  -- Max stamina.
  self.container_img:draw_region(55, 8, 2 + self.max_stamina_displayed/12, 8, self.surface)

  -- Current stamina (divided so it takes up less space).
  self.stamina_bar_img:draw_region(55, 32, 2 + self.stamina_displayed/12, 8, self.surface)
end
