return function(game)
  local hero_mode = game:get_value("hero_mode") and "mirror/" or "normal/"
  game.dungeons = {
    [1] = {
      floor_width = 2256,
      floor_height = 2256,
      lowest_floor = -8,
      highest_floor = 6,
      maps = {hero_mode .. "Dungeon/ForbiddenWood/test" },
      boss = {
        floor = 6,
        x = 2032,
        y = 536,
    ...
    [2] = {
      ...
      highest_floor = 0,
      maps = { 
	    hero_mode .. "Dungeon/GoronSanctuary/boss/boss", 
	    hero_mode .. "Dungeon/GoronSanctuary/boss/boss - Copie",
		hero_mode .. "Dungeon/GoronSanctuary/boss/boss - Copie (2)"
	  },
      boss = {
        floor = 0,
        x = 1130,
