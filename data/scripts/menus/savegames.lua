...
function savegame_menu:set_initial_values(savegame)
    ...
    savegame:set_starting_location("interiors/knight_academy/1", "from_intro")
	...
	savegame:set_value("item_1_kb_slot", savegame:get_value("_keyboard_item_2"))
	
	savegame:set_value("item_saved_kb_action", savegame:get_value("_joypad_action"))
	savegame:set_value("item_1_kb_slot", savegame:get_value("_joypad_item_1"))
	savegame:set_value("item_1_kb_slot", savegame:get_value("_joypad_item_2"))
