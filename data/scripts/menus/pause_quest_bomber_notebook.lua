...
function bomber_notebook_submenu:load_extra()
...
function bomber_notebook_submenu:set_cursor_position(position)
...
function bomber_notebook_submenu:on_draw(dst_surface)
...
function bomber_notebook_submenu:on_command_pressed(command)
  ...
  if not handled then
    ...
    elseif command == "down" then
      sol.audio.play_sound("menu/cursor")
      self:set_cursor_position(self.cursor_position + 1)
	  if self.cursor_position >= 10 then
	    self:set_cursor_position(1)
	  end
      handled = true
...
return bomber_notebook_submenu